...
\begin{example}
    ...
    \end{example}   
		...
		Let us move to another example, which is an entertaining problem, but which we do not know how to solve.
    \begin{example}
