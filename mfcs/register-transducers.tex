...
\begin{definition}[Register transducer] Let $\aalg$ be an algebra (in the sense of universal algebra, i.e.~a set with some operations on it). The syntax of a  \emph{nondeterministic tree-to-$\aalg$ register transducer} consists of:
    \begin{enumerate}
