    ...
    %J
        ...
        \begin{proof} 
            ...
            \begin{itemize}
                ...
                An $(i,j)$-walk in the fusion $f(G_1,G_2)$ is either an $(i,j)$-walk in $G_1$ or an $(i,j)$-walk in $G_2$, because vertices between endpoints cannot be sources; these cases are disjoint, except hypothetical walk of length 1 from $i$ to $j$. %Furthermore, these cases are disjoint, since we are working with graphs that have parallel edges.
